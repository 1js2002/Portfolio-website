    ...
    >
      ...
      <div className="space-y-3 px-0 md:px-10">
        ...
        <p className="text-base">
          - 👋 Hi there! My name is Dinesh. <br></br>- 🎓 I have a Bachelor
          Degree in Information Technology. <br></br>- 🌍 I love exploring the
          latest advancements in the tech world.<br></br>- 💻 In my free time, I
          like to work on personal coding projects and contribute to open-source
          projects.<br></br>- 🌷 I also find meditation to be a great way to
          clear my mind and focus on my goals.<br></br>- ✌️ Im open to
          opportunities.
        </p>
      </div>
    </motion.div>
